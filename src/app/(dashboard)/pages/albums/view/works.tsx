...
import { FiPlus, FiImage, FiVideo, FiChevronRight, FiClock } from 'react-icons/fi';
  ...
  useEffect(() => {
    const fetchAlbums = async () => {
      ...
      try {
        ...
        const mapped: ViewAlbum[] = apiAlbums.map((a) => {
          ...
          {albums.map((album) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="mt-3 flex items-center text-xs text-gray-500 space-x-4"></div>
              </div>
            </div>
          ))}
        </div>
